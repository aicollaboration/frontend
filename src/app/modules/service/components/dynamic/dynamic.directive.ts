...
import {IOMapInfo} from './iomap-info';
...
@Directive({
  selector:
    '[appDynamicInputs],[appDynamicOutputs],[ngComponentOutletAppDynamicInputs],[ngComponentOutletAppDynamicOutputs]',
})
export class DynamicDirective implements OnChanges, DoCheck, OnDestroy {
  @Input() appDynamicInputs: { [k: string]: any };
  @Input() ngComponentOutletAppDynamicInputs: { [k: string]: any };
  @Input() appDynamicOutputs: { [k: string]: Function };
  @Input() ngComponentOutletAppDynamicOutputs: { [k: string]: Function };
  ...
  private get _inputs() {
    return this.appDynamicInputs || this.ngComponentOutletAppDynamicInputs;
  }

  private get _outputs() {
    return this.appDynamicOutputs || this.ngComponentOutletAppDynamicOutputs;
  }
  ...
  private _inputsChanged(changes: SimpleChanges): boolean {
    return (
      'ngComponentOutletAppDynamicInputs' in changes ||
      'appDynamicInputs' in changes
    );
  }

  private _outputsChanged(changes: SimpleChanges): boolean {
    return (
      'ngComponentOutletAppDynamicOutputs' in changes ||
      'appDynamicOutputs' in changes
    );
  }
