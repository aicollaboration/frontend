...
@Directive({
  selector: '[appDynamicAttributes],[ngComponentOutletAppDynamicAttributes]',
  exportAs: 'appDynamicAttributes',
})
export class DynamicAttributesDirective implements DoCheck {
  @Input() appDynamicAttributes: AttributesMap;
  @Input() ngComponentOutletAppDynamicAttributes: AttributesMap;
  ...
  private get _attributes() {
    return (
      this.appDynamicAttributes || this.ngComponentOutletAppDynamicAttributes
    );
  }
