...
export class SearchMockApi implements TreoMockApi {
    // Private Readonly
    private readonly defaultNavigation: TreoNavigationItem[] = defaultNavigation;
    private readonly contacts: any[] = contacts;

    /**
     * Constructor
     *
     * @param treoNavigationService
    ...
    register(): void {
        ...
        const flatNavigation = this.treoNavigationService.getFlatNavigation(this.defaultNavigation);
        ...
        this.treoMockApiService
            ...
            .reply((request) => {
                ...
                // Filter the contacts
                const contactsResults = cloneDeep(this.contacts).filter((user) => {
